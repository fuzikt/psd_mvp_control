...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.buttonProgramStepInsert = QtWidgets.QPushButton(self.groupBoxProgram)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.buttonProgramStepInsert.sizePolicy().hasHeightForWidth())
        self.buttonProgramStepInsert.setSizePolicy(sizePolicy)
        self.buttonProgramStepInsert.setObjectName("buttonProgramStepInsert")
        self.gridLayout_2.addWidget(self.buttonProgramStepInsert, 0, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.buttonProgramStepInsert.setText(_translate("MainWindow", "Insert..."))
